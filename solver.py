...
class Solver:
    def __init__(self, maze_path: str, maze_res: list, measurement: bool = False, cp: list = [0, 0], end: list = [0, 0]) -> None:
    ...
    def load_maze(self, reverse: bool = True, from_list: bool = False, list: list = [], start: list = [], end: list = []) -> None:
        if from_list:
            self.maze_list = list
            if reverse:
                self.cp = end
